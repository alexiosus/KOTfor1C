...
- Исправлена ложная диагностика неизвестного шага для аргументов вида `[Параметр]` и шагов с многострочными табличными данными; строки примера таблицы больше не принимаются за параметры шага.
